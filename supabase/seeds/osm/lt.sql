...
FROM (VALUES
  ...
  ('Stalo tenisas Birštono miesto centrinis parkas (2)','parc_exterior','Birštonas','Birštonas',NULL,'Algirdo g. 25, Birštonas',54.608565,24.02996,2,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ...
  ('Stalo tenisas Beržynėlis','parc_exterior','Šiauliai','Šiauliai',NULL,'Gegužių g. 51A, Šiauliai',55.91089,23.256795,2,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ...
  ('Stalo tenisas Draugystės g.','parc_exterior','Visaginas','Visaginas',NULL,'Draugystės g. 10B, Visaginas',55.592605,26.4470175,4,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ('Stalo tenisas Draugystės parkas','parc_exterior','Kaunas','Kaunas',NULL,'Kovo 11-osios g. 72, Kaunas',54.91385,23.972645,2,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ...
  ('Stalo tenisas Draugystės parkas (2)','parc_exterior','Kaunas','Kaunas',NULL,'Taikos pr. 83, Kaunas',54.91485,23.97043,1,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ...
  ('Stalo tenisas Munto','parc_exterior','Vilnius','Vilnius',NULL,'Manufaktūrų g. 24, Vilnius',54.678295,25.31925,4,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ('Stalo tenisas Uosių g.','parc_exterior','Šiauliai','Šiauliai',NULL,'Uosių g. 2, Šiauliai',55.931995,23.327915,2,true,false,NULL,NULL,ARRAY['exterior'],true,false),
