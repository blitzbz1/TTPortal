...
FROM (VALUES
  ...
  ('Table tennis Κέντρο Πολιτισμού Ίδρυμα Σταύρος Νιάρχος','parc_exterior','Moskháton','Nomarchía Athínas',NULL,'Κέντρο Πολιτισμού Ίδρυμα Σταύρος Νιάρχος, Moskháton',37.94173,23.69045,2,true,true,NULL,NULL,ARRAY['exterior'],true,false),
  ('Table tennis Αθλητικό Πάρκο Αγ. Γεωργίου','parc_exterior','Tríkala','Trikala',NULL,'Αθλητικό Πάρκο Αγ. Γεωργίου, Tríkala',39.544415,21.78753,2,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ...
  ('Table tennis Periyali Crèche & Children''s Club','parc_exterior','Argási','Nomós Zakýnthou',NULL,'Periyali Crèche & Children''s Club, Argási',37.710935,20.989115,2,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ...
  ('Table tennis Πάρκο Ναυαρίνου','parc_exterior','Ilioúpoli','Nomarchía Athínas',NULL,'Πάρκο Ναυαρίνου, Ilioúpoli',37.9390633,23.7515033,3,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ...
  ('Table tennis Πολυτεχνείο Κρήτης','parc_exterior','Pithári','Nomós Chaniás',NULL,'Πολυτεχνείο Κρήτης, Pithári',35.52802,24.06731,2,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ('Table tennis Sani Rest','parc_exterior','Néa Fókaia','Nomós Chalkidikís',NULL,'Sani Rest, Néa Fókaia',40.10119,23.30938,2,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ...
  ('Table tennis Νέο Πάρκο','parc_exterior','Flórina','Nomós Florínis',NULL,'Νέο Πάρκο, Flórina',40.782315,21.409565,2,true,false,NULL,NULL,ARRAY['exterior'],true,false),
