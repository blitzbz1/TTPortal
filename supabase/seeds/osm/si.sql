...
FROM (VALUES
  ('Namizni tenis Osnovna šola Riharda Jakopiča','parc_exterior','Ljubljana','Ljubljana',NULL,'Vodnikova cesta 56a, Ljubljana',46.06752,14.488315,2,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ('Namizni tenis Osnovna šola Franceta Bevka','parc_exterior','Ljubljana','Ljubljana',NULL,'Ulica Pohorskega bataljona 1, Ljubljana',46.077885,14.50678,2,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ('Namizni tenis Osnovna šola Valentina Vodnika','parc_exterior','Ljubljana','Ljubljana',NULL,'Vodnikova cesta 162, Ljubljana',46.074185,14.47676,2,false,false,NULL,NULL,ARRAY['exterior'],true,false),
  ('Namizni tenis Park Ade Škerl in Sonje Plaskan','parc_exterior','Ljubljana','Ljubljana',NULL,'Cimpermanova ulica 4, Ljubljana',46.043395,14.50884,2,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ...
  ('Namizni tenis ProDive','parc_exterior','Pekre','Urban Municipality of Maribor',NULL,'Borova vas 7, Pekre',46.543625,15.619675,2,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ...
  ('Namizni tenis River Camping Bled','parc_exterior','Bled','Municipality of Bled',NULL,'Alpska cesta 111, Bled',46.36651,14.135105,2,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ('Namizni tenis Lukmar Prevozi Transport in Logistika','parc_exterior','Izlake','Municipality of Zagorje ob Savi',NULL,'Izlake 3, Izlake',46.15391,14.929095,2,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ('Namizni tenis Grajski Park Fužine','parc_exterior','Ljubljana','Ljubljana',NULL,'Rusjanov trg 5, Ljubljana',46.05161,14.56235,2,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ...
  ('Namizni tenis Športni park Kodeljevo','parc_exterior','Ljubljana','Ljubljana',NULL,'Ulica Carla Benza 16, Ljubljana',46.04953,14.531855,2,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ('Namizni tenis Osnovna Šola Oskarja Kovačiča','parc_exterior','Ljubljana','Ljubljana',NULL,'Vandotova ulica 6, Ljubljana',46.032885,14.522135,2,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ...
  ('Namizni tenis Na krogih','parc_exterior','Nova Gorica','Urban Municipality of Nova Gorica',NULL,'Ulica Gradnikove brigade 15, Nova Gorica',45.95934,13.64576,4,true,true,NULL,NULL,ARRAY['exterior'],true,false),
  ...
  ('Namizni tenis ŽAK','parc_exterior','Ljubljana','Ljubljana',NULL,'Milčinskega ulica 1, Ljubljana',46.07073,14.497205,2,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ...
  ('Namizni tenis Brejčeva ulica','parc_exterior','Ljubljana','Ljubljana',NULL,'Brejčeva ulica 2, Ljubljana',46.04774,14.517885,2,true,false,NULL,NULL,ARRAY['exterior'],true,false)
