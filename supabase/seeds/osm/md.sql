...
FROM (VALUES
  ...
  ('Masă de ping pong Parcul „Valea Trandafirilor”','parc_exterior','Chisinau','Chișinău Municipality',NULL,'Parcul „Valea Trandafirilor”, Chisinau',47.0040575,28.8532525,4,true,false,NULL,NULL,ARRAY['exterior'],true,false),
