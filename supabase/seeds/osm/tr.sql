...
FROM (VALUES
  ('Ela Quality Four Ways Square','parc_exterior','Belek','Serik',NULL,'Ela Quality Four Ways Square, Belek',36.85417,31.04243,1,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ...
  ('Karayolları Parkı','parc_exterior','Cikcilli','Alanya',NULL,'Karayolları Parkı, Cikcilli',36.54013,32.02426,1,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ...
  ('Yoğurtçu Parkı','parc_exterior','Üsküdar','Üsküdar',NULL,'Yoğurtçu Parkı, Üsküdar',40.98488,29.03355,1,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ('Avcılar Sahil Yolu','parc_exterior','Yakuplu','Beylikdüzü',NULL,'Avcılar Sahil Yolu, Yakuplu',40.97243,28.7428067,3,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ('Yaşam Vadisi','parc_exterior','İçmeler','Tuzla',NULL,'Yaşam Vadisi, İçmeler',40.83479,29.312535,2,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ('Dostluk Parkı','parc_exterior','Etimesgut','Etimesgut İlçesi',NULL,'Dostluk Parkı, Etimesgut',39.96477,32.7301967,3,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ('Pınarça Dere Kenarı Park','parc_exterior','Çerkezköy','Çerkezköy',NULL,'Pınarça Dere Kenarı Park, Çerkezköy',41.28807,28.00729,1,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ('2 Tables','parc_exterior','Beldibi','Konyaaltı',NULL,'Beldibi',36.71039,30.57013,1,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ('Ağva Kıyı Rekreasyon Alanı Parkı','parc_exterior','Ağva','Şile',NULL,'Ağva Kıyı Rekreasyon Alanı Parkı, Ağva',41.13726,29.84977,1,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ('Voyage Belek Golf & Spa','parc_exterior','Belek','Serik',NULL,'Voyage Belek Golf & Spa, Belek',36.84747,31.07393,1,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ('Bahçeşehir Doğa Parkı','parc_exterior','Esenyurt','Esenyurt',NULL,'Bahçeşehir Doğa Parkı, Esenyurt',41.06443,28.69745,1,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ('Swandor Topkapı Palace','parc_exterior','Kumköy','Serik',NULL,'Swandor Topkapı Palace, Kumköy',36.8564,30.91542,1,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ('Hamitler Spor Parkı','parc_exterior','Nilüfer','Nilüfer',NULL,'Hamitler Spor Parkı, Nilüfer',40.25066,28.99126,1,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ('Başakşehir Sular Vadisi','parc_exterior','Başakşehir','Başakşehir',NULL,'Başakşehir Sular Vadisi, Başakşehir',41.11245,28.80654,1,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ('Atatürk Kültür Parkı','parc_exterior','Antalya','Antalya',NULL,'Atatürk Kültür Parkı, Antalya',36.88527,30.67309,1,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ('Şht. Ahmet Tepeli Parkı','parc_exterior','Sultangazi','Sultangazi',NULL,'Şht. Ahmet Tepeli Parkı, Sultangazi',41.10415,28.86584,1,true,false,NULL,NULL,ARRAY['exterior'],true,false)
