-- LI — Liechtenstein — 5 venues, 4 cities
...
FROM (VALUES
  ('Primarschule Aeule','parc_exterior','Vaduz','Vaduz',NULL,'Giessenstrasse 7, Vaduz',47.137885,9.519695,2,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ('Schulzentrum Mühleholz','parc_exterior','Schaan','Schaan',NULL,'Marianumstrasse 43, Schaan',47.15573,9.50505,1,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ('Weiterführende Schulen Triesen','parc_exterior','Triesen','Triesen',NULL,'Landstrasse 313, Triesen',47.1048,9.52639,1,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ('Robinson-Spielplatz','parc_exterior','Triesen','Triesen',NULL,'Alte Landstrasse 1, Triesen',47.09211,9.52483,1,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ('Sport- und Freizeitanlage Weiherring','parc_exterior','Mauren','Mauren',NULL,'Weiherring 25, Mauren',47.21877,9.54407,1,true,false,NULL,NULL,ARRAY['exterior'],true,false)
