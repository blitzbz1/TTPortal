...
FROM (VALUES
  ('Tischtennis Primarschule Aeule','parc_exterior','Vaduz','Vaduz',NULL,'Giessenstrasse 7, Vaduz',47.137885,9.519695,2,true,false,NULL,NULL,ARRAY['exterior'],true,false),
