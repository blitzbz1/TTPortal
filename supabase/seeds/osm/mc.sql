...
FROM (VALUES
  ('Parc Princesse Antoinette','parc_exterior','Monaco','Municipality of Monaco',NULL,'Chemin des Salines 104, Monaco',43.733465,7.41405,2,true,false,NULL,NULL,ARRAY['exterior'],true,false),
  ('Parking du Chemin des Pêcheurs','parc_exterior','Monaco','Municipality of Monaco',NULL,'Parking du Chemin des Pêcheurs, Monaco',43.73114,7.427175,2,true,false,NULL,NULL,ARRAY['exterior'],true,false)
