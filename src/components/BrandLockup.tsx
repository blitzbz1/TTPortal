...
export function BrandLockup({
  ...
  return (
    <View style={[styles.lockup, gap != null && { gap }, style]} accessibilityLabel="TTPortal">
      <BrandPin color={color} width={pinWidth} />
      {showWordmark ? (
        <Text
          ...
          style={[
            styles.wordmark,
            {
              ...
              lineHeight: Math.round(wordmarkSize * 1.12),
            },
          ]}
        >
          TTPortal
...
const styles = StyleSheet.create({
  ...
  wordmark: {
    flexShrink: 1,
    fontFamily: SYSTEM_FONT ?? Fonts.heading,
    fontWeight: '800',
    letterSpacing: 0,
