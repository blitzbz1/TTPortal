...
export function createStyles(colors: ThemeColors) {
  ...
  const styles = StyleSheet.create({
    ...
    reviewSortRow: { flexDirection: 'row', gap: 6 },
    reviewSortChip: {
      paddingHorizontal: 10,
      paddingVertical: 5,
    ...
    reviewSortTextActive: { color: colors.primaryMid },
    emptyReviewsCompact: {
      flexDirection: 'row',
      alignItems: 'center',
      gap: 10,
    ...
    abQuiet: { flexDirection: 'row', gap: 8 },
    qbtn: {
      width: 64, alignItems: 'center', justifyContent: 'center', gap: 6,
    ...
    qbtnText: { fontFamily: Fonts.body, fontSize: 10, lineHeight: 12, fontWeight: FontWeight.bold, color: colors.text, textAlign: 'center' },
    qbtnRouteText: { color: colors.text },
